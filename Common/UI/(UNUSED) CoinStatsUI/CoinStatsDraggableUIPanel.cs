...
//	public class CoinStatsDraggableUIPanel : UIPanel
//	{
...
//			// (In our example, the parent would be CoinStatsUI, a UIState. This means that we are checking that the DraggableUIPanel is outside the whole screen)
